...
class Evaluator(object):
    ...
    def __init__(self, true, pred, tags):
        ...
        self.metrics_results = { 'correct': 0,
                                 'incorrect': 0,
                                 'partial': 0,
                                 'missed': 0,
                                 'spurious': 0,
        ...
        self.results = { 'strict': deepcopy(self.metrics_results),
    ...
    def evaluate(self):
        ...
        ##LOG.info( 'Imported %s predictions for %s true examples',
        ...
        for true_ents, pred_ents in zip(self.true, self.pred):
            ...
            #self.total_ent += len(collect_named_entities(pred_ents))
