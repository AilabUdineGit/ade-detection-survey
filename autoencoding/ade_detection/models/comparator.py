...
class Comparator(object):
    ...
    def __init__(self, tasks:list, result_filename:str, detok = True, model_filename = None, just_last=False):
        ...
        self.best = Best(best_strict, best_partial)
    ...
    def convert_ids_tags_to_iob(self, tags, task):
        ...
        for tag in tags:
            ...
            if tag > 0:
                ...
                annotation_tag = "B-" if tag % 2 == 0 else "I-"
                iob_tags.append(annotation_tag + task.goal[annotation_index].name)
    ...
    def getAllMetrics(self, task):
       ...
       # for col in metrics_partial_df.columns:
       #     print(col, metrics_partial_df[col].item())
       # print()
       # for col in metrics_strict_df.columns:
       #     print(col, metrics_strict_df[col].item())
