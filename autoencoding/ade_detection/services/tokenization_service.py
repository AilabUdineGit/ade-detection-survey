...
class TokenizationService(object):
    ...
    def __init__(self, dataset: CORPUS):  
        ...
        print("Tokenizing...")
        for doc in tqdm(docs, desc="Tokenization"):

            # Try to fix wrong annotations where annotation interval 
            # and annotation text mismatches!!!
            for span in doc.spans:
                for annotation in span.annotations:
                    if annotation.key == ANNOTATION_TYPE.ADR: #TODO
