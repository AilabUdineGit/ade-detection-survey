...
class SMM4H2020T3Importer(BaseImporter):
    ...
    def load_dataset(self):
        ...
        df = pd.read_csv("assets/datasets/2020_task3/task3_2020.tsv", low_memory=False, sep="\t", dtype=dtype)  
