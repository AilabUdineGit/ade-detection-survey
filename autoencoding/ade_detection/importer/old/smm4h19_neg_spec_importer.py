...
class SMM4H19NegSpecImporter(BaseImporter):
    ...
    def load_dataset(self):
        ...
        df = pd.read_csv("/mnt/HDD/sscaboro/repo/ADE_myversion/assets/datasets/smm4h19_real_neg_spec/CleanFixedFullDataSet.csv", dtype=dtype) 
